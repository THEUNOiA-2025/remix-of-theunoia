...
const ProjectDetailPage = () => {
  ...
  const [phaseStates, setPhaseStates] = useState<any[]>([]);
  ...
  const handleApproveWithPayment = async () => {
    ...
    try {
      ...
      // 1. Create Order
      const orderData = await PaymentService.createOrder(project.id);
