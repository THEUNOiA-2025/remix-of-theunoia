    ...
    <section className="landing-hero-wrap">
      <section className="landing-hero">
        <video
          ...
          playsInline
        >
          <source src="https://oeleyonqaowubcfreqoy.supabase.co/storage/v1/object/public/videos//demovid.mp4" type="video/mp4" />
        </video>
        ...
        <div className="landing-hero-content">
          ...
          <div className="demo-frame">
            <video
              ...
              playsInline
            >
              <source src="https://oeleyonqaowubcfreqoy.supabase.co/storage/v1/object/public/videos//HeroVideo.mp4" type="video/mp4" />
            </video>
          </div>
        </div>
      </section>
